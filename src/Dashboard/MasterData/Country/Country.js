              ...
              <div className="row mb-2">
                ...
                <div className="col-sm-6">
                  <ol className="breadcrumb float-sm-right">
                    ...
                    <li className="breadcrumb-item" ><Link to='/Group'>Country </Link> </li>
                  </ol>
                </div>
                ...
                <div className='col-12 mt-3'>
                    <Link to='AddCountry'><button type="button" style={{width:'250px' , backgroundColor : '#fb9500' , border : 'none'}} class="btn btn-primary" ><i class="fas fa-plus"></i> Add New Country</button></Link> 
                </div>
                            ...
                            <div className='col-12'>
                                ...
                                <Card >
                                    <div className='card-header' style={{backgroundColor: '#fb9500' , color : 'white'}}>
                                        <h3 class="card-title" style={{fontSize : "15px"}} >Results for "All Country"</h3>
                                    </div>
